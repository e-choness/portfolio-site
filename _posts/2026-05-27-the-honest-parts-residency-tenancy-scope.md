...
The reflex, when you're building a tool that makes guarantees, is to maximize what you promise. The opposite reflex is the correct one. The credibility of everything Aegis *does* enforce that is composable guardrails, fail-closed routing, audited verdicts, principal-scoped budgets, governed tool traffic which rests on being unambiguous about the things it can't enforce and won't pretend to.
