...
| **Aegis AI Gateway** | A self-hosted AI gateway that shows its work. | Python, FastAPI, LangGraph, Docker | [open in EchoOS](https://e-choness.github.io/portfolio-site/#/proj/aegis) · [code](https://github.com/e-choness/aegis) · [live](https://huggingface.co/spaces/echoness/aegis-server) |
