...
| **NeighborIQ** | AI-powered real estate intelligence platform for neighborhood insights, ML price predictions, and automated data ingestion. | FastAPI, Vue 3, PostgreSQL, Elasticsearch | [open in EchoOS](https://e-choness.github.io/portfolio-site/#/proj/neighbor-iq) · [code](https://github.com/e-choness/NeighborIQ) |
...
- **Projects**: one file per project in `_projects/`:
  ...
  - links: `github_url`, `live_url` + `live_label`, `website_url`
